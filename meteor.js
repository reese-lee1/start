document.querySelector('.stApp').addEventListener('click', function(event) {
    console.log('Click event triggered on .stApp!');
    ...
    document.querySelector('.stApp').appendChild(meteor);
